...
import 'package:warehouse_manegment_system/customer/screens/Main/HomeCostumers.dart';
...
import 'package:warehouse_manegment_system/staff/model/services/product_details_by_barcode_service.dart';

import 'package:warehouse_manegment_system/staff/view/widgets/custom_card.dart';
...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      //   )
      // ],
      appBar: sharedPreferences!.getString("role") == "staff"
          ? AppBar(
